...
import { BozzaCertificatoService } from './BozzaCertificato.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-BozzaCertificato',
	templateUrl: './BozzaCertificato.component.html',
	styleUrls: ['./BozzaCertificato.component.css'],
  providers: [BozzaCertificatoService]
})
export class BozzaCertificatoComponent implements OnInit {
  ...
  constructor(private serviceBozzaCertificato:BozzaCertificatoService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceBozzaCertificato.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    ...
    return this.serviceBozzaCertificato.addAsset(this.asset)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateAsset(form: any): Promise<any> {
    ...
    return this.serviceBozzaCertificato.updateAsset(form.get("idcert").value,this.asset)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceBozzaCertificato.deleteAsset(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceBozzaCertificato.getAsset(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
